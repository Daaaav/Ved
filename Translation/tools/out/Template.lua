...
PLATFORM_VCE = "<L.PLATFORM_VCE>",
ENABLETOWER = "<L.ENABLETOWER>",
DISABLETOWER = "<L.DISABLETOWER>",
TIMETRIALS = "<L.TIMETRIALS>",
DIMENSIONS = "<L.DIMENSIONS>",
TOWERDIRECTIONUP = "<L.TOWERDIRECTIONUP>",
TOWERDIRECTIONDOWN = "<L.TOWERDIRECTIONDOWN>",
TOWERENTRYEXIT = "<L.TOWERENTRYEXIT>",
SWITCHEDTOALTSTATEMAIN = "<L.SWITCHEDTOALTSTATEMAIN>",
SWITCHEDTOALTSTATE = "<L.SWITCHEDTOALTSTATE>",
ADDEDALTSTATE = "<L.ADDEDALTSTATE>",
REMOVEDALTSTATE = "<L.REMOVEDALTSTATE>",
ENABLEDTOWER = "<L.ENABLEDTOWER>",
DISABLEDTOWER = "<L.DISABLEDTOWER>",
TOWERASCENDING = "<L.TOWERASCENDING>",
TOWERDESCENDING = "<L.TOWERDESCENDING>",
TOWERENTRYSET = "<L.TOWERENTRYSET>",
...
CHANGINGPATHAFTERASK = "<L.CHANGINGPATHAFTERASK>",

VCE_DEPRECATED = "<L.VCE_DEPRECATED>",
