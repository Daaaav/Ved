			...
			for _,command in pairs(commands) do
				if #v > #command then
					if v:match("^" .. command .. "[%(,%)]" .. flag1 .. "[%(,%)]") then
						separator1, separator2 = v:sub(#command+1, #command+1), v:sub(#command+#flag1+2, #command+#flag1+2)
					...
					elseif v:match("^" .. command .. "[%(,%)]" .. flag2 .. "[%(,%)]") then
						separator1, separator2 = v:sub(#command+1, #command+1), v:sub(#command+#flag2+2, #command+#flag2+2)
