		...
		},
		{
			DrawingFunction(
				function(x, y, maxw, maxh)
					font_ui:printf(L.MAP_STYLE, x, y, maxw, "center")
					for k,v in pairs({
			...
			ScreenContainer(
				{
					DrawingFunction(
						function(x, y, maxw, maxh)
							font_ui:printf(L.SHIFTROOMS, x, y+6, 8*10, "center")
							...
							font_ui:print(arrow_left, x+8*10+1, y+10+1)
							font_ui:print(arrow_right, x+8*13+1, y+10+1)
							font_ui:print(arrow_up, x+8*11+4+1, y+1)
							font_ui:print(arrow_down, x+8*11+4+1, y+10+8+1)
						end
					),
