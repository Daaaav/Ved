...
ver = "1.1.4" -- Displayed in title and used in plugin minimum version check ([^otek]ver[^sct])
checkver = ver -- update check, displayed in crash (used to have a or b as opposed to ver)

vergroups = {1,4} -- This'll be pattern-matched later
...
tinynumbers = love.graphics.newImageFont("tinynumbersfont.png", "0123456789.,~RTYUIOPZXCVHBLSF{}")
